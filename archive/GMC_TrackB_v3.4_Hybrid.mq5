//+------------------------------------------------------------------+
//|              G MONEY CORE — TRACK B v3.4  (HYBRID)              |
...
input string EA_Name           = "GMC Track B v3.4 Hybrid";
...
input double TP1_R             = 1.2;   // partial-close trigger (R)
input double TP_Final_R        = 3.8;   // hard TP (R)
...
input double Trail_R_Step      = 0.45;
